...
class hhruSpider(scrapy.Spider):
    ...
    start_urls = ['https://spb.hh.ru/search/vacancy?L_save_area=true&clusters=true&enable_snippets=true&text=python&showClusters=true']
    ...
    def vacancy_parse(self,response:HtmlResponse):
        ...
        vacancy_link = response.xpath("//link[@rel='canonical']/@href").extract()
